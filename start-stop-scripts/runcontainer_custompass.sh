...
docker run --name wildfly-admin-custompass -p 9600:8080 -p 9601:9990 -e WILDFLY_ADMIN_USERNAME=admin -e WILDFLY_ADMIN_PASSWORD=admin123456 -d lukastosic/wildfly-admin
